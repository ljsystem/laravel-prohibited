...
class ProhibitedWithAllTest extends TestCase
{
    private $request;
    ...
    public function testWithoutOneProhibitedAttribute(): void
    {
        ...
        $validation = Validator::make($this->request->all(), [
            'firstAttribute' => 'prohibited_with_all:secondAttribute',
        ]);
    ...
    public function testWithOneProhibitedAttribute(): void
    {
        ...
        $this->assertEquals('The first attribute is prohibited with all second attribute.', $validation->errors()->first('firstAttribute'));
    }
    ...
    public function testWithoutMultipleProhibitedAttributes(): void
    {
        ...
        $validation = Validator::make($this->request->all(), [
            'firstAttribute' => 'prohibited_with_all:secondAttribute,thirdAttribute',
        ]);
    ...
    public function testWithMultipleProhibitedAttributes(): void
    {
        ...
        $this->assertTrue($validation->fails());
        $this->assertTrue($validation->errors()->has('firstAttribute'));
        $this->assertEquals('The first attribute is prohibited with all second attribute, third attribute.', $validation->errors()->first('firstAttribute'));
    }
}
